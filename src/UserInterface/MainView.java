...
public class MainView extends JFrame {
	...
	JLabel startTemperatureLabel = new JLabel("Start Temperature:");
	JLabel endTemperatureLabel = new JLabel("End Temperature:");
	JLabel reduceParameterLabel = new JLabel("Reduce Parameter:");
	...
	JTextField startTemperatureTextField = new JTextField("300");
	JTextField endTemperatureTextField = new JTextField("20");
	JTextField reduceParameterTextField = new JTextField("0.95");
	...
	MainView()
	{
		...
		startTemperatureLabel.setBounds(700, 70, 120, 30);
		startTemperatureTextField.setBounds(820, 70, 50, 30);
		endTemperatureLabel.setBounds(700, 110, 120, 30);
		endTemperatureTextField.setBounds(820, 110, 50, 30);
		reduceParameterLabel.setBounds(700, 150, 150, 30);
		reduceParameterTextField.setBounds(820, 150, 50, 30);
		...
		cp.add(startTemperatureLabel);
		cp.add(startTemperatureTextField);
		cp.add(endTemperatureLabel);
		cp.add(endTemperatureTextField);
		cp.add(reduceParameterLabel);
		cp.add(reduceParameterTextField);
		cp.add(startButton);
	...
	private void setParameter(int count) {
		...
		if (dataSet.getIsAuto()) {
			...
			parameter.setStartTemperature(generation/2);
			parameter.setEndTemperature(30);
			parameter.setReduceParameter(0.95);
		} else {
			parameter.setGeneration(Integer.parseInt(generationTextField.getText()));
			parameter.setStartTemperature(Integer.parseInt(startTemperatureTextField.getText()));
			parameter.setEndTemperature(Integer.parseInt(endTemperatureTextField.getText()));
			parameter.setReduceParameter(Double.parseDouble(reduceParameterTextField.getText()));
		}
	}
